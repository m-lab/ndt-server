...
// === BEGIN code copied from ../html/libndt7.js ===
// {
...
// }
// === END code copied from ../html/libndt7.js ===

process.env.NODE_TLS_REJECT_UNAUTHORIZED = "0"  // accept any certificate
const client = libndt7.newClient({
  hostname: '127.0.0.1',
  port: 4444
})
client.on(libndt7.events.downloadServer, function (message) {
  console.log(message)
})
